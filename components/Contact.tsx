            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-900 font-medium break-words">info@halalyt.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-900 font-medium">+44 7757277744</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-gray-900 font-medium">Serving Local Businesses Nationwide</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <form className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  className="w-full px-4 sm:px-5 py-3 sm:py-4 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-all text-sm sm:text-base"
              ...
              <div>
                <label htmlFor="business" className="block text-xs sm:text-sm font-semibold text-gray-700 mb-2">
                  Business Type
                </label>
                <input
                  type="text"
              ...
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  rows={4}
                  className="w-full px-4 sm:px-5 py-3 sm:py-4 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-black focus:border-black transition-all resize-none text-sm sm:text-base"
              ...
              <button
                type="submit"
                className="w-full bg-black text-white px-6 py-4 sm:py-5 rounded-lg font-bold text-base sm:text-lg hover:bg-gray-800 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                Send Message
                <Send size={18} />
              </button>
